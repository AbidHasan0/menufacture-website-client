      ...
      <div className='grid grid-cols gap-3 justify-items-center mt-2'>
         <div class="card card-compact w-96 bg-base-100 shadow-xl ">
            ...
            <div class="card-body ">
               ...
               <p className='text-bold'>List of Technology and Skill- 2.CSS 3.Bootstrap 4.Tailwind 5.JavaScript 6.React 7.Firebase Authentication 8.React-Router 9.React-Dom 10.JWT 11.Node.js 12.MongoDB 13.Express 14.React-Form</p>
               <p>Best 3 Project Link:
